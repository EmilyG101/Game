    ...
    while run:
        ...
        if boss_active:
            ...
            if boss_intro:
                ...
                # Boss fires bullets downward in volleys
                boss_fire_timer += 1
                if boss_fire_timer > 40:
                    boss_fire_timer = 0
                    for i in range(-1, 2):
                        boss_bullets.append([boss_x + i*60, boss_y + SHIP2_IMG.get_height(), 7])
                ...
                for b in player1_bullets[:]:
                    for i in range(-1, 2):
                        boss_rect = pygame.Rect(boss_x + i*60 - SHIP2_IMG.get_width()//2, boss_y, SHIP2_IMG.get_width(), SHIP2_IMG.get_height())
