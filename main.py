...
def game_loop(multiplayer=False):
    ...
    while run:
        ...
        # --- Level 1, 2, 4, 5, Bosses and other code unchanged ---
        # ... (rest of your code remains as before, including player bullets, UI, menus, etc.) ...

        # --- Player Bullets, Draw Players, Draw Lives, Draw Scores, Game Over, etc. ---
